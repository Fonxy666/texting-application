...
import { passwordMatchValidator, passwordValidator } from '../../../core/validators/ValidPasswordValidator';
...
import { CryptoService } from '../../../core/services/crypto-service/crypto.service';
import { IndexedDBService } from '../../../core/services/db-service/indexed-dbservice.service';
import { ShowFriendRequestData } from '../../../shared/model/responses/user-responses.model';
import { ChangeMessageRequest } from '../../../shared/model/user-credential-requests/user-credentials-requestsmodel.';
import { ChatRoomInviteRequest } from '../../../shared/model/friend-requests/friend-requests.model';
import { ChangePasswordForRoomRequest, GetMessagesRequest } from '../../../shared/model/room-requests/chat-requests.model';
import { ConnectedUser } from '../../../shared/model/chat-models.model';
import { ModifyMessageResponse, ReceiveMessageResponse } from '../../../shared/model/responses/chat-responses.model';
import { ServerResponse } from '../../../shared/model/responses/shared-response.model';
...
export class ChatComponent implements OnInit {
    ...
    async handleInviteToRoom(receiverName: string) {
        ...
        try {
            ...
            if (error.error.message === "The user don't have the key.") {
                const decryptedRoomKey = await this.cryptoService.getDecryptedRoomKey(this.userKey!, this.roomId);
                ...
                if (receiverObject.isSuccess) {
                    ...
                    const receiverPublicKey = receiverObject.data.publicKey;
