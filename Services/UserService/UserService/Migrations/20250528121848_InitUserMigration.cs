    ...
    public partial class InitUserMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendConnections", x => x.ConnectionId);
                    table.ForeignKey(
                        name: "FK_FriendConnections_AspNetUsers_ReceiverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EncryptedSymmetricKeys_UserId_RoomId",
                table: "EncryptedSymmetricKeys",
                columns: new[] { "UserId", "RoomId" });

            migrationBuilder.CreateIndex(
                name: "IX_FriendConnections_ReceiverId_SenderId",
                table: "FriendConnections",
                columns: new[] { "ReceiverId", "SenderId" });

            migrationBuilder.CreateIndex(
                name: "IX_FriendConnections_ReceiverId_Status",
                table: "FriendConnections",
                columns: new[] { "ReceiverId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_FriendConnections_SenderId",
                table: "FriendConnections",
                column: "SenderId");

            migrationBuilder.CreateIndex(
                name: "IX_FriendConnections_Status",
                table: "FriendConnections",
                column: "Status");
