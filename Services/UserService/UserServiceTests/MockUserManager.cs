...
{
    public static Mock<UserManager<ApplicationUser>> Create(ApplicationUser? existingUser = null)
    {
        ...
        existingUser ??= new ApplicationUser("example.url")
        {
        ...
        userManagerMock
            ...
            .ReturnsAsync("mocked-reset-token");
